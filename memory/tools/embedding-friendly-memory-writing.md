...
After a significant memory restructure or new atomic file, run a retrieval test with deliberately different wording from the stored text. If the right chunk comes back strongly, the embeddings are doing their job.
...
2026-04-17 — Created during V2 bootstrap
