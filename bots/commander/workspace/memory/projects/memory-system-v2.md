...
On 2026-04-17, the workspace adopted a structured memory model. `MEMORY.md` serves as a small pointer index and durable recall lives in atomic files under `memory/`.
